...
<button id="addbtn" type='button'  style="width:99%;" class="btn btn-success">Add Admin +</button>
...
<!--      <div class="form-group">
 ...
 <input type="submit" style="float:right" name="add_admin" id="submit" class="btn btn-success" value="Submit" />  
...
<!--             <th>Transaction Id</th>
    ...
    $fetch=mysqli_query($c1,'SELECT * From account_tbl WHERE accessright = "1"'); 
 ...
 <form  role='form' action='del_admin.php' method='post' >
    <div class='form-group'>
      ...
      <label ><center>Are you sure you want to delete '".$row['user_name']."' ?</center></label>
                ...
                <div class='modal-footer'>
                    <button type='submit' name='del_admin'  class='btn btn-success'>Yes</button>
