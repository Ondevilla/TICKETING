...
CREATE TABLE `event_tbl` (
  ...
  `status` enum('Admission','Sold Out','Closed','Upcoming') DEFAULT NULL,
  PRIMARY KEY (`event_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

/*Data for the table `event_tbl` */

insert  into `event_tbl`(`event_id`,`event_name`,`description`,`event_image`,`event_time`,`event_date`,`venue_id`,`venue_name`,`status`) values (8,'Paramore','paramore mo to','images/P_paramore.jpg','00:00:00','2018-02-28',NULL,'dito','Sold Out'),(9,'Paramore','Paramore','images/P_paramore.jpg','00:00:00','2018-03-01',NULL,'dito','Sold Out'),(10,'Paramore','Paramore','images/P_paramore.jpg',NULL,'2018-03-02',NULL,'dito','Admission'),(11,'Paramore','Paramore','images/P_paramore.jpg',NULL,'2018-03-10',NULL,'dito','Admission'),(12,'Paramore1','Paramore','images/P_paramore.jpg',NULL,'2018-03-04',NULL,NULL,'Admission');
